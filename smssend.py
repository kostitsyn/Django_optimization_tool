...
def get_msg():
	...
	message = 'Ваш сайт посетили'
	return message

def main():
	# api_id=get_api_id()
	api_id='74F27C0D-3F2B-7B46-BA13-40EC9CDDF877'
	if api_id is None:
	...
	url="http://sms.ru/sms/send?api_id=%s&to=%s&text=%s&partner_id=3805" %(api_id, '+79199010895', quote(get_msg()))
	# if cliargs.debug==True:
	# 	url="%s&test=1" % (url)
